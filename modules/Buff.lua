...
local MODNAME = "Buff"
local Buff = QuartzE:NewModule(MODNAME, "AceEvent-3.0", "AceBucket-3.0", "AceTimer-3.0")
...
local framefactory = {
	__index = function(t,k)
		local bar = QuartzE:CreateStatusBar(nil, UIParent)
		t[k] = bar
...
function Buff:OnInitialize()
	...
	QuartzE:RegisterModuleOptions(MODNAME, getOptions, L["Buff"])
end
