...
local MODNAME = "Focus"
local Focus = QuartzE:NewModule(MODNAME, "AceEvent-3.0")
...
function Focus:OnInitialize()
	...
	QuartzE:RegisterModuleOptions(MODNAME, getOptions, L["Focus"])
	
	self.Bar = QuartzE.CastBarTemplate:new(self, "focus", MODNAME, L["Focus"], db)
end
