...
local Target = QuartzE:NewModule(MODNAME, "AceEvent-3.0")
...
function Target:OnInitialize()
	...
	QuartzE:RegisterModuleOptions(MODNAME, getOptions, L["Target"])

	self.Bar = QuartzE.CastBarTemplate:new(self, "target", MODNAME, L["Target"], db)
end
