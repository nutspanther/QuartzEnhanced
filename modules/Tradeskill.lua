...
local Tradeskill = QuartzE:NewModule(MODNAME, "AceEvent-3.0", "AceHook-3.0")
...
function Tradeskill:OnInitialize()
	...
	QuartzE:RegisterModuleOptions(MODNAME, getOptions, L["Tradeskill Merge"])
end
...
function Tradeskill:UNIT_SPELLCAST_START(object, event, unit, guid, spellID)
	...
	if isTradeskill then
		...
		castBar:SetStatusBarColor(unpack(QuartzE.db.profile.castingcolor))
