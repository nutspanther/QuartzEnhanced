...
local MODNAME = "Pet"
local Pet = QuartzE:NewModule(MODNAME, "AceEvent-3.0")
...
function Pet:OnInitialize()
	...
	QuartzE:RegisterModuleOptions(MODNAME, getOptions, L["Pet"])

	self.Bar = QuartzE.CastBarTemplate:new(self, "pet", MODNAME, L["Pet"], db)
end
