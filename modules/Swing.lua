...
local MODNAME = "Swing"
local Swing = QuartzE:NewModule(MODNAME, "AceEvent-3.0")
...
function Swing:OnInitialize()
	...
	QuartzE:RegisterModuleOptions(MODNAME, getOptions, L["Swing"])
...
function Swing:OnEnable()
	...
	if not swingbar then
		...
		swingstatusbar = QuartzE:CreateStatusBar(nil, swingbar)
